            ...
            $.get("api/cars/" + element, function(response3) {
              ...
              for (var i = 0; i < response3.length; ++i) {
                ...
                $.ajax({
                  ...
                  newCard.append($("<br><i class='fas fa-suitcase'>"));
                  newCard.append(
                    $("<div class='card-title'><i class='fas fa-users'>").text(
                      "Baggage Space: " + rentCars[i].baggageSpace
                    )
                  );
                  newCard.append($("<i class='fas fa-users'>"));
                  newCard.append(
                    $("<div class='card-title'>").text(
                      "Passenger Capacity: " + rentCars[i].people
                    )
                  );
                  newCard.append($("<i class='fas fa-dollar-sign'>"));
                  newCard.append(
                    $("<div class='card-title' id='cost'>").text(
                      "Estimated Price: $" + apiInfo[i].estimated_total.amount
                    )
                  );
                  newCard.append($("<i class='fas fa-car'>"));
                  newCard.append(
